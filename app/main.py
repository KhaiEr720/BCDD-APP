...
if st.sidebar.button('Predict'):
    ...
    if recurrence_prob > no_recurrence_prob:
        result = f'The patient is likely to have <br><div style="background-color:#ff3b89; padding: 10px; border-radius: 5px;"><b> Recurrence Events</b></div><br>'
        result += f'<div style="background-color:; padding: 10px; border-radius: 5px;">The probability of <b>Recurrence Event</b> is {recurrence_prob:.5f} and the probability of <b>No Recurrence Event</b> is {no_recurrence_prob:.5f}.</div>'
    else:
        result = f'The patient is likely to have <div style="background-color:#0bdb81; padding: 10px; border-radius: 5px;"><b>No Recurrence Events</b></div><br>'
        result += f'<div style="background-color:; padding: 10px; border-radius: 5px;">The probability of <b>No Recurrence Event</b> is {no_recurrence_prob:.5f}.<br> The probability of <b>Recurrence Event</b> is {recurrence_prob:.5f}.</div>'
